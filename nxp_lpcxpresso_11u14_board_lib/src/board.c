...
void Board_LED_Set(uint8_t LEDNumber, bool On)
{
	if(LEDNumber == 1)
	{
		Chip_GPIO_SetPinState(LPC_GPIO, LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM, On);
	}
	else if(LEDNumber == 2)
	{
...
bool Board_LED_Test(uint8_t LEDNumber)
{
	if(LEDNumber == 1)
	{
		return Chip_GPIO_GetPinState(LPC_GPIO, LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM);
	}
	else if(LEDNumber == 2)
	{
...
void Board_LED_Toggle(uint8_t LEDNumber)
{
	if(LEDNumber == 1)
	{
		Chip_GPIO_SetPinToggle(LPC_GPIO, LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM);
	}
	else if(LEDNumber == 2)
	{
